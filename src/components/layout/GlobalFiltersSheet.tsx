  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "sm:hidden relative flex items-center justify-center w-10 h-10 rounded-full transition-all",
          hasActiveFilters
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-0 bottom-0 z-[60] bg-white rounded-t-3xl sm:hidden"
